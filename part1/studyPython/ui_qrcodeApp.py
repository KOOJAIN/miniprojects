...
# Form implementation generated from reading ui file 'c:\source\miniprojects\part1\miniprojects\part1\miniprojects\part1\studyPython\qrcodeApp.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lblQrCode.sizePolicy().hasHeightForWidth())
        self.lblQrCode.setSizePolicy(sizePolicy)
        self.lblQrCode.setAutoFillBackground(False)
